      ...
      <div className="contact-section">
        <div className="contact-content">
          ...
          <p>
            ...
            find me (no too much though) on social if that’s more your style. I’m always open to
        ...
        <div className="contact-actions">
          ...
          <div className="social-links">
            <Link
              to={"https://github.com/iamhugofelix"}
            ...
            <Link
              to={"https://linkedin.com/in/iamhugofelix"}
              className="btn btn-icon-only"
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <Link
              to={"https://medium.com/@iamhugofelix"}
              className="btn btn-icon-only"
              target="_blank"
              rel="noopener noreferrer"
            >
